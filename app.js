...
function A(){
  for(let i =0;i<l;i++){
    ...
    console.log(i)
    console.log(title)
    var demo = document.getElementById("results")
    var B = '<div class="video"><div width=20%><span style="display:inline"><a href="http://www.google.com"><img src="video_thumbnail" class="video_thumbnail" width=400px auto></img></a></div> <div width=80%><a href="http://www.google.com"><p class="title"></p></a><div><span class="views";display:inline></span> · <span class="date_posted"></span></div></br><div><span display:inline><img src="" class="profile_photo" width=40px;height=40px ></span><span class="author"></span></div></br><p class="description"</p></span></div></div>'

    demo.innerHTML=B
      document.querySelector(".video_thumbnail").src=video_thumbnail
      document.querySelector(".title").innerText=title
      document.querySelector(".date_posted").innerText=date_posted
      document.querySelector(".profile_photo").src=profile_photo
      ...
      console.log("Acctually I don't know how to do the form, so the following i was almost struct.")
      
    //querySelector("#results").add='<img src="video_thumbnail">'
  }
}
document.querySelector("#btn-show-all").addEventListener("click", A)
//document.querySelector("#title").addEventListener("click", WOP)
